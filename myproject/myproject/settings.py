...
Generated by 'djangocms' command using django CMS 4.1.0 and Django 4.2.9.
...
SECRET_KEY = 'django-insecure-vipwog02#9m$#!^4o_u1vue_!x4bjd81zjorfiihcpk&-ojz#+'
...
CMS_TEMPLATES = [
   ...
   # ('index.html','National Institute of Technology Warangal'),
]
